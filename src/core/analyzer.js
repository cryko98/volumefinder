...
export class TokenAnalyzer {
    ...
    meetsAllCriteria(volumeSpike, momentum, buyerCount, liquidity, token) {
        return (
        // 1. Market cap >= $40k
    ...
    calculateFinalScore(volumeSpike, momentum, buyerCount, liquidity) {
        ...
        // Apply weights
        const finalScore = volumeSpikeScore * this.weights.volumeSpike +
